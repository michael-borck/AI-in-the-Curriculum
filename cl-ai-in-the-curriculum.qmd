...
[https://michael-borck.github.io/AI-in-the-Curriculum/](https://michael-borck.github.io/AI-in-the-Curriculum/)
...
## Moving Forward: AI as Learning Partner
...
| **Guide on the side** | AI acts as a guide to navigate physical and conceptual spaces | Teachers use ChatGPT to generate content for classes/courses (e.g., discussion questions) and advice on how to support students in learning specific concepts. |
...
| **Motivator** | AI offers games and challenges to extend learning | Teachers or students ask ChatGPT for ideas about how to extend students' learning after providing a summary of the current level of students' knowledge (e.g., quizzes, exercises). |
| **Dynamic assessor** | AI provides educators with a profile of each student's current knowledge | Students interact with ChatGPT in a tutorial-type dialogue and then ask ChatGPT to produce a summary of their current state of knowledge. Students can also ask ChatGPT for dynamic assessments. |


::: {.notes}

So how do we move to productive use? UNESCO's research identifies multiple roles AI can play in education - not as replacement, but as partner."

**Walk through key roles** (pick 3-4 based on time):

**Possibility Engine example**: "Students use ChatGPT to brainstorm essay topics. One student was stuck on a history assignment until AI helped generate 10 different angles - they chose one they'd never considered."

**Socratic Opponent**: "In my business ethics class, students argue one position while ChatGPT argues the opposite. Forces them to strengthen their reasoning - can't just say 'because I think so.'"

**Personal Tutor** (relate to shame): "This addresses the shame issue directly - students can ask AI 'dumb questions' they're embarrassed to ask in class. No judgment, infinite patience."

**Study Buddy**: "Perfect for exam prep. Students explain concepts TO the AI - if they can't explain it clearly, they don't understand it yet."

**Key message**: "Notice none of these replace YOU. They augment learning. AI handles repetitive tasks so you can focus on what only humans do - inspire, connect, judge quality, provide wisdom."

**Address elephant**: "Some of you might be thinking 'but students will cheat.' Remember - it's not about the tool, it's about the task design. If AI can complete your assignment alone, the assignment needs redesigning."

**Practical takeaway**: "Pick ONE role from this table. Try it next week. Start small."

"Let me show you how one colleague did exactly that..."
